...
In my claims about lambda functions in general, its sometimes important to understand that some lambda functions automatically have a pointer to themself for recursion (specifically in occamsfuncer opcodes numbered 1-7).
