...
This kind of math guarantees an evolution selection pressure equal or greater than sexual compared to asexual reproduction, of lambda functions, and that their compute time and memory cost is considered proportionally in their reproductive fitness, and that any existing information or software or thought etc has some possible form. (maybe someday we will figure out what Spore was supposed to become...) I suggest λa.λb.λc.a(λm.λn.n)bc as a "piece of lambda dna" which may allow many lambdas in general to reproduce sexually among eachother more than asexually, but more detailed examples... TODO
